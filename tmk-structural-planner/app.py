...
def build_world_map_svg(products: List[int], selected_product: int) -> str:
    width = 1100
    height = 760
    stage_y = {
        "0": 90,
    ...
    for p in products:
        ...
        svg.append(
            f'''
            <a href="?product={p}" target="_self" class="hub-link">
...
world_svg = build_world_map_svg(products, st.session_state.product)
